...
from app.security.webhook_signature import verify_webhook_signature as _verify_webhook_signature
...
def verify_webhook_signature(
    ...
    return _verify_webhook_signature(payload, signature, secret)
