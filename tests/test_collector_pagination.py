...
class TestMockCollectorPagination:
    def test_search_page_returns_page(self):
        ...
        page = adapter.search_page(
            city="Алматы", category="мебель", page=1, page_size=3
        )
    ...
    def test_search_page_second_page(self):
        adapter = MockCollectorAdapter()
        page = adapter.search_page(
            city="Алматы", category="мебель", page=2, page_size=3
        )
        assert page.page == 2
        assert len(page.items) == 3
    ...
    def test_search_page_has_more(self):
        adapter = MockCollectorAdapter()
        page1 = adapter.search_page(
            city="Алматы", category="мебель", page=1, page_size=3
        )
        assert page1.has_more is True

        page2 = adapter.search_page(
            city="Алматы", category="мебель", page=2, page_size=3
        )
    ...
    def test_search_page_beyond_data(self):
        adapter = MockCollectorAdapter()
        page = adapter.search_page(
            city="Алматы", category="мебель", page=100, page_size=3
        )
    ...
    def test_search_page_provider_metadata(self):
        adapter = MockCollectorAdapter()
        page = adapter.search_page(
            city="Алматы", category="мебель", page=1, page_size=6
        )
    ...
    def test_all_items_have_source_id(self):
        adapter = MockCollectorAdapter()
        page = adapter.search_page(
            city="Алматы", category="мебель", page=1, page_size=100
        )
